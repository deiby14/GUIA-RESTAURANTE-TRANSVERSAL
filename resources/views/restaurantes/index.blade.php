...
<body>
                ...
                <ul class="navbar-nav">
                    @if(auth()->check())
                        <li class="nav-item mt-2 mb-2">
                            <a href="{{ route('restaurantes.index') }}" class="btn btn-hover-grey btn-danger" style="margin-right: 10px;">Restaurantes</a>
                        </li>
                        <li class="nav-item mt-2 mb-2">
    ...
    <div class="container mt-5">
        ...
        <p>Aquí se mostrarán los restaurantes.</p>

        <!-- Ejemplo de lista de restaurantes -->
        <ul>
            <li>Restaurante 1</li>
            <li>Restaurante 2</li>
            <li>Restaurante 3</li>
